...
public class PersistenceManager {
    private static String url = "jdbc:mysql://localhost:3306/cateringdb?serverTimezone=UTC";
    ...
    //Questo metodo esegue una query SQL di tipo SELECT
    ...
    //Questo metodo esegue un'operazione di aggiornamento SQL (INSERT, UPDATE, DELETE).
